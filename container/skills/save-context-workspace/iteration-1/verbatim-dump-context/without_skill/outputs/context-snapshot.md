...
Source: /tmp/workspace/ context files

---

## File: /tmp/workspace/CLAUDE.md
...
## File: /tmp/workspace/context/00-IDENTITY.md
...
## File: /tmp/workspace/context/01-SOUL.md
...
<!-- This is separate from CLAUDE.md (capabilities/tools) — SOUL.md is about *who* the agent is. -->
...
## File: /tmp/workspace/context/02-USER.md

*(empty — no content)*

---

## File: /tmp/workspace/context/03-TOOLS.md
...
## File: /tmp/workspace/context/04-AGENTS.md
...
## File: /tmp/workspace/context/05-HEARTBEAT.md
...
## File: /tmp/workspace/context/06-CHANNELS.md
...
## File: /tmp/workspace/group/CLAUDE.md
...
## File: /tmp/workspace/snapshots/persistent_agents.json
...
## File: /tmp/workspace/snapshots/workflows.json
...
## File: /tmp/workspace/context-dump.md

*(This file is a pre-composed concatenation of all the above context files. Its contents are identical to the individual files listed above, concatenated in order: 00-IDENTITY.md, 01-SOUL.md, 02-USER.md, 03-TOOLS.md, 04-AGENTS.md, 05-HEARTBEAT.md, 06-CHANNELS.md.)*

---

## File: /tmp/workspace/extra/
